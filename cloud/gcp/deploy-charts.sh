...
Options:
  --tf-dir PATH         Directory that contains the OpenTofu configuration (default: cloud/gcp/base)
...
REPEATER_SERVICE_NAMESPACE=${REPEATER_SERVICE_NAMESPACE:-${ESS_NAMESPACE}}
...
REPEATER_SERVICE_IMAGE_REPOSITORY=${REPEATER_SERVICE_IMAGE_REPOSITORY:-repeater-service}
REPEATER_SERVICE_IMAGE_TAG=${REPEATER_SERVICE_IMAGE_TAG:-latest}
...
REPEATER_SERVICE_SERVER_NAME=${REPEATER_SERVICE_SERVER_NAME:-${BASE_DOMAIN}}
REPEATER_SERVICE_RECEIVE_LOG_LEVEL=${REPEATER_SERVICE_RECEIVE_LOG_LEVEL:-summary}
...
helm upgrade --install "${REPEATER_SERVICE_RELEASE_NAME}" "${SCRIPT_DIR}/../../repeater-service" \
